...
// constants
const double kDt = 0.06;		// delta t: 60 ms for each measurement update (observed from logging)
const double kSlowDownCTEThreshold = 1.2;
const double kSlowDownRate = 0.7;
